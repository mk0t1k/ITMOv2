...
- Как проверим риск:
  - Напишем интеграционные тесты с фиктивными секретами, провести ручную проверку воспроизводимости по OUT-1 и evidence
...
- Что проверили и исправили сами: уточнил и немного отформатировал контекст(проверка рисков) и сделал схему поподробнее
